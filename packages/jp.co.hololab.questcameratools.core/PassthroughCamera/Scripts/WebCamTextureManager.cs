...
//
// This code has been modified by HoloLab.
...
namespace PassthroughCameraSamples
{
    ...
    public class WebCamTextureManager : MonoBehaviour
    {
        ...
        private IEnumerator InitializeWebCamTexture()
        {
            ...
            // In order to avoid a crash on Unity 6000, we need to wait for a while before initializing the WebCamTexture.
            yield return new WaitForSeconds(1f);
#else
            yield return new WaitForEndOfFrame();
#endif

            // Commented out by HoloLab
            /*
